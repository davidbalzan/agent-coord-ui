---
title: "Agent Coord UI Methodology"
tags: [agent-coord-ui/core]
aliases: ["Methodology"]
---

# Agent Coord UI Methodology
...
**Agent Coord UI** is about maintaining momentum while building complex software with AI assistance. The key principles:
